<?php namespace App\Http\Controllers;
	...
	class AdminPesertaDidikDataUtamaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'NISN','name'=>'NISN','type'=>'text','validation'=>'numeric|max:10','width'=>'col-sm-3'];
            ...
            $this->form[] = ['label'=>'Rt','name'=>'rt','type'=>'text','validation'=>'numeric','width'=>'col-sm-1'];
			$this->form[] = ['label'=>'Rw','name'=>'rw','type'=>'text','validation'=>'numeric','width'=>'col-sm-1'];
			...
			$this->form[] = ['label'=>'Anak Ke','name'=>'anak_ke','type'=>'text','validation'=>'numeric|max:2','width'=>'col-sm-1'];
			$this->form[] = ['label'=>'Penerima Kps','name'=>'penerima_kps','type'=>'select','validation'=>'required','width'=>'col-sm-2','dataenum'=>'Ya;Tidak','help'=>'Kosongkan Jika Bukan Penerima'];
			$this->form[] = ['label'=>'No Kps','name'=>'no_kps','type'=>'text','validation'=>'numeric|max:10','width'=>'col-sm-3'];
			$this->form[] = ['label'=>'Penerima Kip','name'=>'penerima_kip','type'=>'select','validation'=>'required','width'=>'col-sm-2','dataenum'=>'Ya;Tidak'];
			$this->form[] = ['label'=>'No Kip','name'=>'no_kip','type'=>'text','validation'=>'numeric','width'=>'col-sm-3','help'=>'Kosongkan Jika Bukan Penerima','placeholder'=>'Kosongkan Jika Bukan Penerima'];
			$this->form[] = ['label'=>'Nama Di Kip','name'=>'nama_kip','type'=>'text','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Alasan Layak Pip','name'=>'alasan_layak_pip','type'=>'text','width'=>'col-sm-10','help'=>'Kosongkan Jika Bukan Penerima','placeholder'=>'Kosongkan Jika Bukan Penerima'];
			...
			//$this->form[] = ['label'=>'Rt','name'=>'rt','type'=>'text','validation'=>'numeric','width'=>'col-sm-1'];
			//$this->form[] = ['label'=>'Rw','name'=>'rw','type'=>'text','validation'=>'numeric','width'=>'col-sm-1'];
			//$this->form[] = ['label'=>'Provinsi','name'=>'provinces_id','type'=>'select2','width'=>'col-sm-5','datatable'=>'provinces,name'];
			//$this->form[] = ['label'=>'Kabupaten/Kota','name'=>'cities_id','type'=>'select','width'=>'col-sm-5','datatable'=>'cities,name','parent_select'=>'provinces_id'];
			//$this->form[] = ['label'=>'Kode Pos','name'=>'kode_pos','type'=>'number','validation'=>'required|max:5','width'=>'col-sm-2'];
			//$this->form[] = ['label'=>'Tempat Tinggal','name'=>'tempat_tinggal','type'=>'select2','width'=>'col-sm-3','datatable'=>'tempat_tinggal,nama'];
			//$this->form[] = ['label'=>'Moda Transportasi','name'=>'moda_transportasi','type'=>'select2','width'=>'col-sm-3','datatable'=>'moda_transportasi,nama'];
			//$this->form[] = ['label'=>'No Kks','name'=>'no_kks','type'=>'text','validation'=>'max:10','width'=>'col-sm-3'];
			//$this->form[] = ['label'=>'Anak Ke','name'=>'anak_ke','type'=>'text','validation'=>'numeric|max:2','width'=>'col-sm-1'];
