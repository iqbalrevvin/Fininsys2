<?php namespace App\Http\Controllers;
	...
	class AdminJabatanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "no_urut";
			$this->limit = "20";
			$this->orderby = "no_urut,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"No. Urutan","name"=>"no_urut","width"=>"5"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'No. Urut','name'=>'no_urut','type'=>'number','validation'=>'required','width'=>'col-sm-2','placeholder'=>'Anda hanya dapat memasukkan huruf saja'];
			...
			$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'text','validation'=>'min:3|max:255','width'=>'col-sm-10'];
