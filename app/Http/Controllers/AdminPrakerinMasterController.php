<?php namespace App\Http\Controllers;
	...
	class AdminPrakerinMasterController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form = [];
			//$this->form[] = ['label'=>'Nama Master','name'=>'nama','type'=>'text','validation'=>'required','width'=>'col-sm-5'];
			//$this->form[] = ['label'=>'Tahun Ajaran','name'=>'tahun_ajaran_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-4','datatable'=>'prodi,nama'];
			//$this->form[] = ['label'=>'Program Studi','name'=>'prodi_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			//$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'text','validation'=>'max:255','width'=>'col-sm-10'];
			# OLD END FORM
