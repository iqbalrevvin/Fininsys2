	...
	<div class="kt-portlet kt-portlet--tabs">
		<div class="kt-portlet__head">
			<div class="kt-portlet__head-toolbar">
				<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#informasi_detail" role="tab">
							<i class="flaticon2-calendar-3"></i> Informasi Detail
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#absensi" role="tab">
							<i class="flaticon2-time"></i> Absensi
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#keuangan" role="tab">
							<i class="flaticon2-percentage"></i> Keuangan
						</a>
					</li>
					<li class="nav-item">
		...
		<div class="kt-portlet__body">
			<div class="tab-content kt-margin-t-20">
				<!--Begin:: INFORMASI DETAIL-->
				@include('pesdik.tab_informasi_detail')
				<!--End:: INFORMASI DETAIL-->
				<!--Begin:: INFORMASI ABSENSI-->
				@include('pesdik.tab_absensi')
				<!--End:: INFORMASI ABSENSI-->
				<!--Begin:: Tab Content-->
				@include('pesdik.tab_keuangan')
				<!--End:: Tab Content-->
