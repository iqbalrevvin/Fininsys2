...
<html lang="en">
    ...
    <head>
        ...
        <meta name='robots' content='noindex,nofollow'/>
          ...
          href="{{ CRUDBooster::getSetting('favicon')?asset(CRUDBooster::getSetting('favicon')):asset('metronic/media/logos/fininsys2-logo.png') }}">
        <!--begin::Fonts -->
                    ...
                    <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{ asset('metronic/media//bg/bg-4.jpg') }});">
                        <div class="kt-grid__item">
                            <a href="#" class="kt-login__logo">
                                <img src='{{ asset('metronic/media/logos/fininsys2-logo.png') }}' 
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
                            <div class="kt-grid__item kt-grid__item--middle">
                                <h3 class="kt-login__title">
                                    {{ CRUDBooster::getSetting('title_login') }}
                                    {{ CRUDBooster::getSetting("title_login")?CRUDBooster::getSetting("title_login"):'Selamat Datang Di Fininsys2' }}
                                </h3>
                                <h4 class="kt-login__subtitle">
                                    {!! CRUDBooster::getSetting('deskripsi_login') !!}
                                </h4>
                            </div>
                        </div>
                        <div class="kt-grid__item">
                            <div class="kt-login__info">
                                <div class="kt-login__copyright">
                                    {!! CRUDBooster::getSetting('footer_login')?CRUDBooster::getSetting('footer_login'):'Fininsys2 © 2019 All Rights Reserved' !!}
                                </div>
                                <div class="kt-login__menu">
                                    <a href="#" class="kt-link">
                                        <i><small>Powered By Laravel CRUDBooster Package</small></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="kt-login__body">
                            ...
                            <div class="kt-login__form">
                                <div class="kt-login__title">
                                    {{-- <h3>Login Akun</h3> --}}
                                    <img src='{{ CRUDBooster::getSetting("logo")?asset(CRUDBooster::getSetting('logo')):asset('metronic/media/logos/fininsys2-logo.png') }}' 
                                    style='max-width: 100%;max-height:170px; text-align: center; margin-left: auto; margin-right: auto;'>
                                </div>
