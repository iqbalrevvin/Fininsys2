                                ...
                                <label class='label-setting' title="{{$s->name}}">
                                    ...
                                    @if(CRUDBooster::isSuperadmin())
                                        ...
                                        <a style="visibility:hidden" href='javascript:;' title='Hapus Komponen Pengaturan' class='btn btn-box-tool'
                                           onClick='swal({   title: "Yakin Dengan Tindakan?",   text: "Tindakan tidak dapat dikembalikan dan memulihkan {{$s->label}} dan mungkin dapat menyebabkan beberapa kesalahan pada sistem!",   type: "warning",   showCancelButton: true,   confirmButtonColor: "#DD6B55",   confirmButtonText: "Ya, Hapus Saja!",   closeOnConfirm: false }, function(){  location.href="{{CRUDBooster::mainpath("delete/$s->id")}}" });'
