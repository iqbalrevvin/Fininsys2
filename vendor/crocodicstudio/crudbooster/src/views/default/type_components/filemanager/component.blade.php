        ...
        @if($value=='')
            <div class="input-group">
                ...
                <span class="input-group-btn">
			        <a id="lfm-{{$name}}" data-input="thumbnail-{{$name}}" data-preview="holder-{{$name}}" class="btn btn-secondary">
			          @if(@$form['filemanager_type'] == 'file')
                            <i class="fa fa-file-alt"></i> {{trans("crudbooster.chose_an_file")}}
                        @else
                            <i class='fa fa-file-image'></i> {{trans("crudbooster.chose_an_image")}}
                        @endif
			        </a>
			      </span>
